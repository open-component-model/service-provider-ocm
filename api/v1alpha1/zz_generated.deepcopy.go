...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OCMVersion) DeepCopyInto(out *OCMVersion) {
	*out = *in
	if in.ChartURL != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OCMVersion.
func (in *OCMVersion) DeepCopy() *OCMVersion {
	if in == nil {
		return nil
	}
	out := new(OCMVersion)
