...
// HelmValues captures the subset of ocm-k8s-toolkit chart values the provider needs to
// act on during reconciliation. Unknown fields are preserved in the raw values passed
// through to the HelmRelease; this struct is only used to read, not rewrite.
